	...
	<view>
			...
			<view class="proRow">
			 	<view class="item d-flex j-sb a-center" v-for="(item,index) in mainData" :key="index">
					<view class="item_selBtn flex">
						<view><image class="seltIcon" src="../../static/images/shopping-icon2.png" v-if="item.isSelect" @click="choose(index)"></image>
		...
		<view class="xqbotomBar d-flex j-sb a-center border-bottom"  style="bottom: 110rpx;z-index: 40;">
			...
			<view class="d-flex j-end a-center" v-show="!is_allDelt">
				...
				<view class="payBtn font-30 text-white main-bg-color" style="width: 260rpx;"  @click="Router.navigateTo({route:{path:'/pages/orderConfim/orderConfim'}})">立即购买</view>
			</view>
