			...
			<view class="proRow">
				<view class="item mb-3">
					<view class="font-24 d-flex j-sb a-center pb-2 border-bottom">
						...
						<view class="red" v-if="curr==2">待支付</view>
						<view class="red" v-if="curr==1||curr==3">待提货</view>
						<view class="red" v-if="curr==4">已提货</view>
						<view class="red" v-if="curr==5">已评价</view>
					</view>
					<view class="d-flex j-sb a-center py-2 inforLine" v-if="curr==2" @click="Router.navigateTo({route:{path:'/pages/productDetail/productDetail'}})">
					...
					<view class="d-flex j-sb a-center py-2 inforLine"  v-if="curr==1||curr==3||curr==4||curr==5" @click="Router.navigateTo({route:{path:'/pages/userOrder-detail/userOrder-detail'}})">
						<view class="picBox d-flex a-center flex-wrap">
							<image src="../../static/images/shopping-img.png" mode=""></image>
							<image src="../../static/images/shopping-img.png" mode=""></image>
							<image src="../../static/images/shopping-img.png" mode=""></image>
					...
					<view class="underBtn d-flex j-end a-center py-3 border-top"  v-if="curr==2">
						<view class="Bbtn mainborder"  @click="Router.navigateTo({route:{path:'/pages/orderConfim/orderConfim'}})">去支付</view>
					</view>
					<view class="underBtn d-flex j-end a-center py-3 border-top"  v-if="curr==4">
						<view class="Bbtn "  @click="Router.navigateTo({route:{path:'/pages/userOrder-pingjiaList/userOrder-pingjiaList'}})">去评价</view>
					</view>
					<view class="underBtn d-flex j-end a-center py-3 border-top"  v-if="curr==5">
						<view class="Bbtn "  @click="Router.navigateTo({route:{path:'/pages/userOrder-pingjiaok/userOrder-pingjiaok'}})">查看评价</view>
					</view>
					<view class="underBtn d-flex j-sb a-center py-3 border-top font-26"  v-if="curr==1||curr==3">
						<view>提货单号：<span class="red">3</span></view>
					</view>
				</view>
			</view>
		</view>
